...
const FinalCTA = () => {
  ...
  return (
    <section id="contact" className="py-20 md:py-28 section-dark">
      <div ref={ref} className={`container mx-auto px-4 lg:px-8 text-center max-w-3xl scroll-hidden ${isVisible ? "scroll-visible" : ""}`}>
        ...
        <p className={`text-lg text-primary-foreground/80 mb-10 leading-relaxed scroll-hidden delay-1 ${isVisible ? "scroll-visible" : ""}`}>
        ...
        <div className={`scroll-hidden delay-2 ${isVisible ? "scroll-visible" : ""}`}>
          <a href="tel:9712393684" className="cta-lime px-10 py-5 rounded-md text-lg font-bold transition-all hover:scale-105 inline-block mb-4">Request Your Free On-Site Estimate</a>
          <div className="mt-2">
        ...
        <div className={`mt-10 flex flex-wrap justify-center gap-4 md:gap-8 text-xs text-primary-foreground/60 font-medium scroll-hidden delay-3 ${isVisible ? "scroll-visible" : ""}`}>
